                ...
                <div class="card-body">
                    <?= form_open_multipart('registrar_usuario',['id' => 'form-user-register','class' => 'user']); ?>
                            ...
                            <div class="col-lg-12">
                                <center>
                                    <?php
                                        $img = array(
                                                        'id' => 'img-preview',
                                                        'src'    => base_url(RECURSOS_PANEL_CONTENIDO.'imagenes/usuario/user.jpg'),
                                                        'alt'    => 'Perfil usuario',
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="text-dark" for="">Perfil (<font color="green">opcional</font>):</label>
                                    <?php
                                        $input = array(
                                            'type' => 'file',
                                            'id' => 'imagen',
...
<?= $this->section("js") ?>
    ...
    <script type="text/javascript" src="<?= base_url(RECURSOS_PANEL_CONTENIDO.'plugins/bootstrapValidator.min.js')?>"></script>
    <!--  -->
