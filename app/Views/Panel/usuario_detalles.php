                            ...
                            <div class="col-lg-12">
                                <center>
                                    <?php
                                        ...
                                        $img = array(
                                                        'id' => 'img-preview',
                                                        'src'    => base_url(RECURSOS_PANEL_CONTENIDO.'imagenes/usuario/'.$foto_perfil),
                                                        'alt'    => 'Perfil usuario',
...
<?= $this->section("js") ?>
    ...
    <script type="text/javascript" src="<?= base_url(RECURSOS_PANEL_CONTENIDO.'plugins/boostrap-validator.min.js')?>"></script>
    <!--  -->
