...
<?= $this->section("css") ?>
    ...
    <link rel="stylesheet" href="<?= base_url(RECURSOS_PANEL_CONTENIDO.'plugins/boostrapValidator.min.css');?>">
        ...
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h5 class="m-0 font-weight-bold text-primary">Registrar nuevo libro</h5>
                ...
                <div class="card-body">
                    <?= form_open_multipart('registrar_calzado',['id' => 'form-user-register','class' => 'user']); ?>
                            ...
                            <div class="col-lg-12">
                                <center>
                                    <?php
                                        $img = array(
                                                        'id' => 'img-preview',
                                                        'src'    => base_url(RECURSOS_PANEL_CONTENIDO.'imagenes/usuario/bookicon.png'),
                         ...
                         <div class="row">
                           <!--  <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="text-dark" for="">Titulo (<font color="red">*</font>):</label>
                                   <!//?php
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="text-dark" for="">Editorial (<font color="red">*</font>):</label>
                                    <?php
                                        $input = array(
                                            'type' => 'text',
                                            'id' => 'color-calzado',
                                            'name' => 'color_calzado',
                                            'class' => 'form-control form-control-user',
                                            'placeholder' => 'Nombre de editorial del libro',
                            ...
                            <div class="col-lg-4">                       
                                <div class="form-group">
                                    <label class="text-dark" for="">Páginas del libro (<font color="red">*</font>):</label><br>
                                    <?php
                                        $input = array(
                                            'type' => 'text',
                                            'id' => 'talla-calzado',
                                            'name' => 'talla_calzado',
                                            'class' => 'form-control form-control-user',
                                            'placeholder' => 'Número de paginas del libro',
                            ...
                            <div class="col-lg-4">                       
                                <div class="form-group">
                                    <label class="text-dark" for="">Genero del libro (<font color="red">*</font>):</label>
                                    <?php
                                        $select = array('class' => 'form-control form-select',
                                                            'id' => 'categoria-calzado'
                                                            );
                                        echo form_dropdown('categoria_calzado', [''=>'Selecciona el genero del libro']+TIPO_CALZADO, set_value('categoria_calzado'), $select);
                                    ?>
                                </div>
                            </div>
                            <div class="col-lg-4">                       
                                <div class="form-group">
                                    <label class="text-dark" for="">Precio del libro (<font color="red">*</font>):</label>
                                    <?php
                                        $input = array(
                                            'type' => 'number',
                                            'id' => 'precio-calzado',
                            ...
                            <div class="col-lg-4">                       
                                <div class="form-group">
                                    <label class="text-dark" for="">Fecha de publicación (<font color="red">*</font>):</label><br>
                                    <?php
                                        $input = array(
                                            'type' => 'text',
                                            'id' => 'talla-calzado',
                                            'name' => 'talla_calzado',
                                            'class' => 'form-control form-control-user',
                                            'placeholder' => 'Ingresa fecha de lanzamiento',
                                            'value' => set_value('talla_calzado')
                                        );
                                        echo form_input($input);
                                    ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php
                                        $input = array(
                                            ...
                                            'placeholder' => 'Escribe aquí la descripción del libro a agregar...',
                                            'class' => 'form-control',
                                            'rows' => '2',
                                        );
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label class="text-dark" for="">Imagen de Portada (<font color="red">*</font>):</label>
                                    <?php
                                        $input = array(
                                            'type' => 'file',
                                            'id' => 'imagen-calzado',
...
<?= $this->section("js") ?>
    ...
    <script type="text/javascript" src="<?= base_url(RECURSOS_PANEL_CONTENIDO.'plugins/bootstrap.min.js'); ?>"></script>
    <script type="text/javascript" src="<?= base_url(RECURSOS_PANEL_CONTENIDO.'plugins/boostrapValidator.min.js')?>"></script>
    <!--  -->
