<?php
    ...
    */
    ...
    function configurar_menu_panel($pagina_actual = '', $sub_pagina_actual = '') {
        ...
        $menu_opcion['icon'] = 'fas fa-feather-alt';
        ...
        $menu_opcion['icon'] = 'fas fa-book-reader';
        $menu_opcion['submenu'] = array();
        ...
        $menu_opcion['href'] = '#';
        $menu_opcion['text'] = 'Libros';
        $menu_opcion['icon'] = 'fa fa-book';
        $menu_opcion['submenu'] = array();
            $menu_sub_opcion = array();
            $menu_sub_opcion['is_active'] = ($sub_pagina_actual == TAREA_CATALOGO_DAMA) ? TRUE : FALSE ;
            $menu_sub_opcion['href'] =  route_to('pagina_catalogo_dama');
            $menu_sub_opcion['text'] = 'Drama';
            $menu_opcion['submenu']['dama'] = $menu_sub_opcion;
            $menu_sub_opcion = array();
            $menu_sub_opcion['is_active'] = ($sub_pagina_actual == TAREA_CATALOGO_SUSPENSO) ? TRUE : FALSE ;
            $menu_sub_opcion['href'] = route_to('pagina_catalogo_suspenso');
            $menu_sub_opcion['text'] = 'Suspenso';
            $menu_opcion['submenu']['Suspenso'] = $menu_sub_opcion;
            $menu_sub_opcion = array();
            $menu_sub_opcion['is_active'] = ($sub_pagina_actual == TAREA_CATALOGO_ROMANTICO) ? TRUE : FALSE ;
            $menu_sub_opcion['href'] = route_to('pagina_catalogo_romantico');
            $menu_sub_opcion['text'] = 'Romantico';
            $menu_opcion['submenu']['Romantico'] = $menu_sub_opcion;
            $menu_sub_opcion = array();
            $menu_sub_opcion['is_active'] = ($sub_pagina_actual == TAREA_CATALOGO_FANTASIA) ? TRUE : FALSE ;
            $menu_sub_opcion['href'] = route_to('pagina_catalogo_fantasia');
            $menu_sub_opcion['text'] = 'Fantasía';
            $menu_opcion['submenu']['Fantasía'] = $menu_sub_opcion;
            $menu_sub_opcion = array();
            $menu_sub_opcion['is_active'] = ($sub_pagina_actual == TAREA_CATALOGO_CIENCIA) ? TRUE : FALSE ;
            $menu_sub_opcion['href'] = route_to('pagina_catalogo_ciencia');
            $menu_sub_opcion['text'] = 'Ciencia Ficción';
            $menu_opcion['submenu']['Ciencia_Ficción'] = $menu_sub_opcion;
