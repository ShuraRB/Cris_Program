    ...
    class Usuario_nuevo extends BaseController{
        ...
        private function cargar_datos(){
            ...
            $datos['imagen_usuario'] = ($session->imagen_usuario != NULL) 
                                            ...
                                            : (($session->sexo_usuario == SEXO_FEMENINO) ? base_url(RECURSOS_PANEL_CONTENIDO.'imagenes/usuario/female.png') : base_url(RECURSOS_PANEL_CONTENIDO.'imagenes/usuario/male.png'));
