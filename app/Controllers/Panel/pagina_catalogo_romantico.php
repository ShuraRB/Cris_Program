<?php 
    ...
    class pagina_catalogo_romantico extends BaseController{
        ...
        public function __construct(){
            ...
            if (acceso_usuario(TAREA_CATALOGO_ROMANTICO)) {
                $session->tarea_actual = TAREA_CATALOGO_ROMANTICO;
            }//end if 
            else{
        ...
        public function index(){
            ...
            if($this->permitido){
                return $this->crear_vista("panel/pagina_catalogo_romantico", $this->cargar_datos());
        ...
        private function crear_vista($nombre_vista, $contenido = array()){
            $contenido['menu'] = crear_menu_panel(TAREA_CATALOGO, TAREA_CATALOGO_ROMANTICO);
        ...
        public function eliminar($id_calzado = 0) {
            ...
            if (!empty($calzado)) {
                ...
                if($tabla_calzados->delete($id_calzado)) {
                    mensaje("El libro ha sido eliminado exitosamente", SUCCESS_ALERT);
                }//end if eliminar
                else {
                    mensaje("Hubo un error al eliminar el libro, intenta nuevamente", DANGER_ALERT);
                }//end else

            }//end if count
            else {
                mensaje("El libro que deseas eliminar no existe", WARNING_ALERT);
            }//end else count
