<?php 
    ...
    class pagina_catalogo_ciencia extends BaseController{
        ...
        public function __construct(){
            ...
            if (acceso_usuario(TAREA_CATALOGO_CIENCIA)) {
                $session->tarea_actual = TAREA_CATALOGO_CIENCIA;
            }//end if 
            else{
        ...
        public function index(){
            ...
            if($this->permitido){
                return $this->crear_vista("panel/pagina_catalogo_ciencia", $this->cargar_datos());
        ...
        private function cargar_datos(){
            ...
            $datos['nombre_pagina'] = 'Ciencia Ficción';
        ...
        private function crear_vista($nombre_vista, $contenido = array()){
            $contenido['menu'] = crear_menu_panel(TAREA_CATALOGO, TAREA_CATALOGO_CIENCIA);
