<?php 
    ...
    class pagina_catalogo_fantasia extends BaseController{
        ...
        public function __construct(){
            ...
            if (acceso_usuario(TAREA_CATALOGO_FANTASIA)) {
                $session->tarea_actual = TAREA_CATALOGO_FANTASIA;
            }//end if 
            else{
        ...
        public function index(){
            ...
            if($this->permitido){
                return $this->crear_vista("panel/pagina_catalogo_fantasia", $this->cargar_datos());
        ...
        private function crear_vista($nombre_vista, $contenido = array()){
            $contenido['menu'] = crear_menu_panel(TAREA_CATALOGO, TAREA_CATALOGO_FANTASIA);
