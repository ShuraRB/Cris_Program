<?php 
    ...
    class pagina_catalogo_suspenso extends BaseController{
        ...
        public function __construct(){
            ...
            if (acceso_usuario(TAREA_CATALOGO_SUSPENSO)) {
                $session->tarea_actual = TAREA_CATALOGO_SUSPENSO;
            }//end if 
            else{
        ...
        public function index(){
            ...
            if($this->permitido){
                return $this->crear_vista("panel/pagina_catalogo_suspenso", $this->cargar_datos());
        ...
        private function crear_vista($nombre_vista, $contenido = array()){
            $contenido['menu'] = crear_menu_panel(TAREA_CATALOGO, TAREA_CATALOGO_SUSPENSO);
